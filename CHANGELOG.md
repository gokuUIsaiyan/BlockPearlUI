...
### Deleted components
- **src/layouts/Signals/Signals.jsx** (renamed to Admin)
...
## [1.2.0] 2018-04-16
### Bug Fixing
- Renamed `src/containers/App/App.jsx` to `src/layouts/Signals/Signals.jsx`
...
- Added design from Material Signals by Creative Tim
